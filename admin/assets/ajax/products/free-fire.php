...
$where = "status = '0' AND type_account = 'Free Fire' ";
if (!empty($username)) {
...
?>
                                        <tr>
                                            ...
                                            <a href="/admin/free-fire/edit/<?php echo $data["id"]; ?>"><button type="button" class="btn btn-primary btn-xs" title="Chỉnh sửa"><span class="ti-pencil-alt2"></span></button></a> 
