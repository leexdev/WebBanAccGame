...
<div class="content">
            <div class="container-fluid">
                ...
                <a href="/admin/lien-quan/create"><button type="button" class="btn btn-success btn-block">Đăng tài khoản</button></a>
                <br/>
                <div class="btn-group btn-group-justified">
                  <a href="/admin/lien-quan/champion" class="btn btn-warning">Dữ liệu tướng</a>
                  <a href="/admin/lien-quan/skin" class="btn btn-warning">Dữ liệu trang phục</a>
                </div>
                </div></div></div>
...
<script>
           function load_list(){
                $(".list").hide();
                $.post("/admin/assets/ajax/products/lien-quan.php", { page : page , username : username , id_acc : id_acc })
                .done(function(data) {
                    $(".list").html('');
