            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Thêm skin vào CSDL</h4>
                            </div>
                            <div class="content">                                
                            <form action="" enctype="multipart/form-data" method="post">
                            <input name="type" type="hidden" value="lq_skin">    
                            <div class="row">
                             <div class="col-sm-3">
                              <div class="form-group">
                                <label for="img">Ảnh Skin:</label>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Danh sách skin trong CSDL</h4>
                            </div>
                            <div class="content">
                <div class="listskin row">
                                    <?php
                                    $list_champ = $db->fetch_assoc("SELECT * FROM lq_skin ORDER BY name DESC",0);
                                    foreach ($list_champ as $item) { 
                                    ?>                                   
                                        <div class="col-sm-1 col-xs-4">
                                        	<div class="featured-article"><img src="/assets/images/lq_skin/<?php echo $item['img_name']; ?>" alt="<?php echo $item['name']; ?>" title="<?php echo $item['name']; ?>" class="img-responsive img-thumbnail" onclick="del_img_champ_skin('lq_skin','<?php echo $item['id']; ?>','<?php echo $item['img_name']; ?>','<?php echo $item['name']; ?>');" width="100" height="100" <?php if($item['vip'] == "yes"){echo 'style="background-color:red;"';}?>><div class="block-title text-center"><?php echo $item['name']; ?></div></div>
                                        </div>
                                    <?php } ?>                            
                </div></div>
