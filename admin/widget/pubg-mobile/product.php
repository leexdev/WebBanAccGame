...
<div class="content">
            <div class="container-fluid">
                ...
                <a href="/admin/pubg-mobile/create"><button type="button" class="btn btn-success btn-block">Đăng tài khoản</button></a>
                </div></div></div>
...
<script>
           function load_list(){
                $(".list").hide();
                $.post("/admin/assets/ajax/products/pubg-mobile.php", { page : page , username : username , id_acc : id_acc })
                .done(function(data) {
                    $(".list").html('');
